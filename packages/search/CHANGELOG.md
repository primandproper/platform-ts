...
- a124406: Add bulk indexing interfaces (`BulkIndexManager`, `BulkTextIndex`, `BulkDocument`), type guards, and a default search limit.
- Updated dependencies [a124406]
- Updated dependencies [a124406]
- Updated dependencies [a124406]
  - @primandproper/circuitbreaking@0.0.2
